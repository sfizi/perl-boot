...
banner = """
             ...
             _____|  | _|__| __| _/ |  | _____    ____    __| _/

            /  ___/  |/ /  |/ __ |  |  | \__  \  /    \  / __ |

            \___ \|    &lt;|  / /_/ |  |  |__/ __ \|   |  \/ /_/ |

            /____  &gt;__|_ \__\____ |  |____(____  /___|  /\____ |

                \/     \/       \/            \/     \/      \/                                 

                           welcome to skid land
...
def main():
    ...
    while True:
        ...
        sys.stdout.write("\x1b]2;SKIDLAND servers {78} Online {34} {130 fucking gigs} \x07")

        sin = input("\033[1;00m[\033[91mskidland\033[1;00m]-\033[91m家\033[00m ").lower()
        ...
        if sinput == "clear":
            ...
            print ("[\033[91mskid land\033[00m] You Are Exiting Out Of skid land come back.\n")
